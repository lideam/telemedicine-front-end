...
import { FaReceipt, FaCheckCircle, FaUndoAlt, FaDownload } from 'react-icons/fa';
  ...
  return (
    <div className="flex min-h-screen bg-gray-50 relative">
      ...
      <div className="max-w-6xl mx-auto bg-white p-8 rounded-xl shadow-xl">
        <h1 className="text-3xl font-semibold text-blue-800 mb-6 mt-5 text-center">Transaction History</h1>
            ...
            transactions.map((transaction) => (
              ...
              >
                <div className="flex flex-col md:flex-row items-start md:items-center md:space-x-4">
                  ...
                  <div>
                    <p className="text-lg font-semibold">{transaction.doctorName}</p>
                    <p className="text-sm text-gray-600">Appointment Date: {transaction.appointmentDate}</p>
                    <p className="text-sm text-gray-600">Transaction Date: {transaction.date}</p>
                  </div>
                </div>

                <div className="text-right mt-4 md:mt-0">
                  <p className="text-lg font-semibold">{transaction.amountPaid} Birr</p>
                  <p
                  ...
                  <div className="mt-4">
                    <button
                      onClick={() => handleDownloadReceipt(transaction.receipt)}
        ...
        <div className="fixed inset-0 bg-gray-500 bg-opacity-50 flex items-center justify-center">
          <div className="bg-white p-6 rounded-lg w-96">
            ...
            <p className="text-lg mb-4">
              <strong>Amount Paid:</strong> {selectedTransaction.amountPaid} Birr
            </p>
